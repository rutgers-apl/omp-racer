...
void knapsack_par(struct item *e, int c, int n, int v, int *sol, int l)
{
      ...
      */
     #pragma omp task firstprivate(e,c,n,v,l) shared(without) if (l < bots_cutoff_value)
     knapsack_par(e + 1, c, n - 1, v, &without,l+1);

     /* compute the best solution with the current item in the knapsack */
     #pragma omp task firstprivate(e,c,n,v,l) shared(with)  if (l < bots_cutoff_value)
...
void knapsack_par(struct item *e, int c, int n, int v, int *sol, int l)
{
     ...
     {
        /* compute the best solution without the current item in the knapsack */
        #pragma omp task firstprivate(e,c,n,v,l) shared(without)
        knapsack_par(e + 1, c, n - 1, v, &without,l+1);

        /* compute the best solution with the current item in the knapsack */
        #pragma omp task firstprivate(e,c,n,v,l) shared(with)
        knapsack_par(e + 1, c - e->weight, n - 1, v + e->value, &with,l+1);
