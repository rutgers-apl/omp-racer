...
#define cilk_sync
#define parallel_main main
#define parallel_for _Pragma("omp parallel for schedule (dynamic,1024)") for
#define parallel_for_1 _Pragma("omp parallel for schedule (dynamic,1)") for
#define parallel_for_256 _Pragma("omp parallel for schedule (dynamic,256)") for
#define OMPP_INIT omprace_init();
#define OMPP_FINI omprace_fini();
