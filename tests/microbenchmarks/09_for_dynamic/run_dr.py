...
pass_compile_flags =  "-fopenmp -O0 -std=c++11 -I./ -I$LLVM_HOME/include -I$OMPP_ROOT/src/omprace/ -I$OMPP_ROOT/src/include -g -fPIE -pie -S -emit-llvm"
omprace_compile_flags =  "-O0 -std=c++11 -I./ -I$LLVM_HOME/include -I$OMPP_ROOT/src/omprace/ -I$OMPP_ROOT/src/include -g -fPIE -pie $OMPP_ROOT/src/omprace/libomprace.a"
