...
#define ompt_callback_dispatch_implemented ompt_event_MAY_ALWAYS_OPTIONAL //omp-whip dynamic loops
#define ompt_callback_task_spawn_implemented ompt_event_MAY_ALWAYS_OPTIONAL //omp-whip task creation
