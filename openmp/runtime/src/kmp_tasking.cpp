...
kmp_task_t *__kmpc_omp_task_alloc(ident_t *loc_ref, kmp_int32 gtid,
                                  ...
                                  kmp_routine_entry_t task_entry) {
  // task_spawn callback omp-whip
  #if OMPT_SUPPORT && OMPT_OPTIONAL
  if (ompt_enabled.ompt_callback_task_spawn) {//nader task spawn 
    ompt_callbacks.ompt_callback(ompt_callback_task_spawn)(
      ompt_scope_begin,
      NULL,
      NULL,
      NULL);
...
#if OMPT_SUPPORT && OMPT_OPTIONAL
  if (ompt_enabled.ompt_callback_work) {//omp-whip taskloop end
    ompt_callbacks.ompt_callback(ompt_callback_work)(
